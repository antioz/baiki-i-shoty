...
window.VENUES = [
  {
    ...
    coverAccent: "#3b2818",
    stories: [
      { id: "tb-1", title: "Магнит-кнопка вместо двери", duration: "02:24", free: true, audio: "../audio/s_term_01.mp3",
        intro: "Март две тысячи десятого, Рубинштейна ещё пустая, по тротуару ходит редкая собака и редкая мысль." },
      { id: "tb-2", title: "Стойка пятнадцать метров и принцип без столов", duration: "02:14", free: false, audio: "../audio/s_term_02.mp3",
      ...
      { id: "tb-3", title: "Довлатов в соседнем подъезде и квартира за двести миллионов", duration: "02:09", free: false, audio: "../audio/s_term_03.mp3",
      ...
      { id: "tb-4", title: "Закрытие как демонстрация", duration: "02:18", free: false, audio: "../audio/s_term_04.mp3",
  ...
  },
  {
    ...
    coverAccent: "#2a1f30",
    stories: [
      { id: "ts-1", title: "Коктейль Довлатов и адрес писателя", duration: "02:15", free: true, audio: "../audio/s_tsv_01.mp3",
        intro: "Коктейль называется Довлатов, и в нём ничего экстраординарного." },
      { id: "ts-2", title: "Шот Нефть и страна, в которой его пьют", duration: "02:15", free: false, audio: "../audio/s_tsv_02.mp3",
        intro: "В меню Цветочков есть шот, который называется Нефть." },
      { id: "ts-3", title: "Распутин в трёх кварталах", duration: "02:21", free: false, audio: "../audio/s_tsv_03.mp3",
        intro: "В пяти минутах ходьбы от Цветочков стоит дом шестьдесят четыре по Гороховой." },
      { id: "ts-4", title: "Словолитня Лемана и буквы империи", duration: "02:22", free: false, audio: "../audio/s_tsv_04.mp3",
  ...
  },
  {
    ...
    coverAccent: "#332518",
    stories: [
      { id: "ge-1", title: "Электричество раньше, чем у царя", duration: "02:16", free: true, audio: "../audio/s_gre_01.mp3",
      ...
      { id: "ge-2", title: "Медовый месяц Чайковского и его последний обед", duration: "02:22", free: false, audio: "../audio/s_gre_02.mp3",
      ...
      { id: "ge-3", title: "Блокадный госпиталь номер девятьсот девяносто один", duration: "02:27", free: false, audio: "../audio/s_gre_03.mp3",
        intro: "Сентябрь сорок первого." },
      { id: "ge-4", title: "Жучки в люстрах и Элтон Джон под наблюдением", duration: "02:20", free: false, audio: "../audio/s_gre_04.mp3",
  ...
  },
  {
    ...
    coverAccent: "#2d2418",
    stories: [
      { id: "pl-1", title: "Бассейн со стерлядью и котлета по-палкински", duration: "02:30", free: true, audio: "../audio/s_pal_01.mp3",
        intro: "В главном зале Палкина стоял бассейн." },
      { id: "pl-2", title: "Достоевский этажом ниже правит Бесов", duration: "02:24", free: false, audio: "../audio/s_pal_02.mp3",
        intro: "В тысяча восемьсот семьдесят втором в этом же доме, со стороны Владимирского, открылась типография купца Траншеля." },
      { id: "pl-3", title: "Учёные обеды Менделеева и враги за одним столом", duration: "02:28", free: false, audio: "../audio/s_pal_03.mp3",
        intro: "Дмитрий Иванович Менделеев был человеком крупным, бородатым и пьющим." },
      { id: "pl-4", title: "От Палкина к тюрьме и кинотеатру Титан", duration: "02:31", free: false, audio: "../audio/s_pal_04.mp3",
